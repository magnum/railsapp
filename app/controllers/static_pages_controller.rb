...
class StaticPagesController < ApplicationController
  ...
  def index
    ...
    @static_pages = policy_scope(current_workspace.static_pages).order(:slug)
  end
  ...
  def new
    @static_page = current_workspace.static_pages.new(state: "created")
    authorize @static_page
  end

  def create
    @static_page = current_workspace.static_pages.new(static_page_params)
    authorize @static_page
  ...
  def set_static_page
    @static_page = current_workspace.static_pages.find_by!(slug: params[:slug])
  end
